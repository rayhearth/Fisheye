export class ImageMediaCards {
    ...
    renderMedia() {
        ...
        article.classList.add('mediaContentCard')
        article.innerHTML = `
        ...
        const icon = document.querySelectorAll('.hearth')
        // Au click
        ...
        function addOneLike() {
            let totalLikes = document.querySelector("#footerInfosCunt").innerHTML++
    ...
    mediaLightboxDOM() {
        ...
        mediaLightboxDiv.id = ${this.id}
        mediaLightboxDiv.innerHTML = `src="assets/images/photographers/${this._photographerId}/media/${this._image}" alt="${this._title}">
